...
// // Demo-Daten: unverändert belassen
// const DEMO_ORDERS: Order[] = [
//   {
//     id: "10000007",
//     auftraggeber: "amat",
...
//   const handleBulkAction = (action: string, selectedIds: string[]) => {
//     // hier bleibt dein (v0)-Logging erhalten
//     console.log("[v0] Bulk action:", action, selectedIds);
//   };
...
//         {/* Ansichtsauswahl rechts – Button „Neuer Auftrag“ hier bewusst entfernt */}
//         <Tabs
//           value={viewMode}
//           onValueChange={(v) => setViewMode(v as "table" | "cards")}
//           className="ml-auto"
